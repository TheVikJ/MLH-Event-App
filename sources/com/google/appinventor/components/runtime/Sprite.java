...
public abstract class Sprite extends VisibleComponent implements AlarmHandler, OnDestroyListener, Deleteable {
    ...
    @SimpleProperty
    /* renamed from: Y */
    public void mo7345Y(double y) {
        updateY(y);
        registerChange();
    }

    /* renamed from: Y */
    public double mo5800Y() {
    ...
    @SimpleProperty
    /* renamed from: Z */
    public void mo7347Z(double layer) {
        this.zLayer = layer;
