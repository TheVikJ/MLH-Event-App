...
public abstract class Quantity extends Numeric {
    ...
    /* renamed from: re */
    public RealNum mo10968re() {
        return number().mo10968re();
    }

    /* renamed from: im */
    public RealNum mo10967im() {
        return number().mo10967im();
    }
    ...
    public double doubleValue() {
        return unit().doubleValue() * mo10968re().doubleValue();
    }

    public double doubleImagValue() {
        return unit().doubleValue() * mo10967im().doubleValue();
    }
