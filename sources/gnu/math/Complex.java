...
public abstract class Complex extends Quantity {
    ...
    public boolean isExact() {
        return mo10968re().isExact() && mo10967im().isExact();
    }

    /* Debug info: failed to restart local var, previous not found, register: 4 */
    public Complex toExact() {
        RealNum re = mo10968re();
        RealNum im = mo10967im();
    ...
    public Complex toInexact() {
        return isExact() ? this : new DComplex(mo10968re().doubleValue(), mo10967im().doubleValue());
    }
    ...
    public double doubleValue() {
        return mo10968re().doubleValue();
    }

    public double doubleImagValue() {
        return mo10967im().doubleValue();
    }
    ...
    public static boolean equals(Complex x, Complex y) {
        return x.mo10968re().equals(y.mo10968re()) && x.mo10967im().equals(x.mo10967im());
    }
    ...
    public static int compare(Complex x, Complex y) {
        int code = x.mo10967im().compare(y.mo10967im());
        return code != 0 ? code : x.mo10968re().compare(y.mo10968re());
    }
    ...
    public boolean isZero() {
        return mo10968re().isZero() && mo10967im().isZero();
    }

    public String toString(int radix) {
        if (mo10967im().isZero()) {
            return mo10968re().toString(radix);
        }
        String imString = mo10967im().toString(radix) + "i";
        if (imString.charAt(0) != '-') {
            imString = "+" + imString;
        }
        return !mo10968re().isZero() ? mo10968re().toString(radix) + imString : imString;
    }

    public static Complex neg(Complex x) {
        return make(x.mo10968re().rneg(), x.mo10967im().rneg());
    }
    ...
    public static Complex add(Complex x, Complex y, int k) {
        return make(RealNum.add(x.mo10968re(), y.mo10968re(), k), RealNum.add(x.mo10967im(), y.mo10967im(), k));
    }
    ...
    public static Complex times(Complex x, Complex y) {
        RealNum x_re = x.mo10968re();
        RealNum x_im = x.mo10967im();
        RealNum y_re = y.mo10968re();
        RealNum y_im = y.mo10967im();
